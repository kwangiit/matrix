...
int generalSendBack(int to_sock, const char* buff_sendback, int buffsize,
	...
	if (tcp == true) {
		...
		sentSize = udpSendBack(to_sock, buff_sendback, buff_size, sendbackAddr,
				flag);
...
int udpSendBack(int sock, const char* buff_sendback, int buffsize,
